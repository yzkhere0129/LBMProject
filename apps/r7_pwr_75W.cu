 ...
 *
 * Usage:
 *   mkdir -p output_r7_pwr_75W && ./sim_line_scan_316L
 *   ParaView: Open output_r7_pwr_75W/line_scan_*.vtk
 */
...
int main() {
    ...
    config.laser_power              = 75.0f;  // R7 power sweep
    ...
    for (int step = 0; step <= num_steps; ++step) {
        ...
        if (step % vtk_every == 0) {
            ...
            snprintf(filename, sizeof(filename),
                     "output_r7_pwr_75W/line_scan_%06d", step);
    ...
    printf("\nOutput: output_r7_pwr_75W/line_scan_*.vtk\n");
    printf("============================================================\n\n");
