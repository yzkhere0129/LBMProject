 ...
 *
 * Usage:
 *   mkdir -p output_round7_h1h4_long && ./sim_line_scan_316L
 *   ParaView: Open output_round7_h1h4_long/line_scan_*.vtk
 */
...
int main() {
    ...
    const float t_total  = 2000.0e-6f;  // R7 long: full Phase-4 length
    ...
    // Initialize
    // ==================================================================
    mkdir("output_round7_h1h4_long", 0755);
    ...
    for (int step = 0; step <= num_steps; ++step) {
        ...
        if (step % vtk_every == 0) {
            ...
            snprintf(filename, sizeof(filename),
                     "output_round7_h1h4_long/line_scan_%06d", step);
    ...
    printf("\nOutput: output_round7_h1h4_long/line_scan_*.vtk\n");
    printf("============================================================\n\n");
