 ...
 *
 * Usage:
 *   mkdir -p output_round8_s1 && ./sim_line_scan_316L
 *   ParaView: Open output_round8_s1/line_scan_*.vtk
 */
...
int main() {
    ...
    for (int step = 0; step <= num_steps; ++step) {
        ...
        if (step % vtk_every == 0) {
            ...
            snprintf(filename, sizeof(filename),
                     "output_round8_s1/line_scan_%06d", step);
    ...
    printf("\nOutput: output_round8_s1/line_scan_*.vtk\n");
    printf("============================================================\n\n");
